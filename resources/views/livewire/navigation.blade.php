@if ($this->position == 'header')
    <div class="max-w-full xl:max-w-7xl mx-auto z-20 top-0 xl:top-8 sticky">
        <div class="xl:rounded-2xl backdrop-blur shadow-2xl shadow-gray-500/30 dark:shadow-gray-900/90 w-full text-gray-700 bg-white/70 dark:text-gray-200 dark:bg-gray-800/70">
...
@elseif ($this->position == 'footer')
    <footer class="py-8 backdrop-blur shadow-2xl shadow-gray-500/30 dark:shadow-gray-900/90 w-full text-gray-700 bg-white/70 dark:text-gray-200 dark:bg-gray-800/70">
        <div class="max-w-full xl:max-w-7xl mx-auto relative">
            ...
            <p class="mx-auto mt-6 max-w-xl leading-relaxed text-center">
                Willkommen bei Code Nova! Hier findest du professionelle Webentwicklungsdienstleistungen, inspirierende Tutorials und einen persönlichen Einblick in meine Welt als Webentwickler.
                Entdecke innovative Lösungen, verbessere deine Programmierkenntnisse und tauche in spannende Blogbeiträge ein.
                Lass uns gemeinsam die Welt des Codes erkunden!
            </p>
